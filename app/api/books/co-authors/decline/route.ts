...
/** POST /api/books/co-authors/decline – Eingeladener Mitautor lehnt die Einladung ab */
export async function POST(request: Request) {
  try {
    ...
    console.error("POST /api/books/co-authors/decline error:", err);
