  ...
  return (
    <main className="top-centered-main">
      <section className="card">
        {isLoading ? (
          <p className="font-sans text-arena-muted text-sm mt-4">Lade Lektorenprofil ...</p>
        ) : message ? (
          ...
          <>
            <div className="grid grid-cols-[96px_1fr] items-center gap-3 max-[400px]:grid-cols-1 max-[400px]:justify-items-center max-[400px]:text-center">
              ...
              <div>
                ...
                {lektorenProfile.motto && <p className="font-sans mt-1 text-sm italic text-arena-muted">„{lektorenProfile.motto}“</p>}
              </div>
            </div>
            ...
            {lektorenProfile.zuMir && (
              <div className="my-2">
                ...
                <p className="font-sans text-sm text-arena-text leading-relaxed mt-1.5 whitespace-pre-wrap"><LinkifyText text={lektorenProfile.zuMir} /></p>
              </div>
            )}
        ...
        />
        <Link href="/lektoren" className="btn font-sans mt-6">Zurück zu Lektoren entdecken</Link>
      </section>
    </main>
  );
}
