...
export default function BloggerProfilePage({ params }: PageProps) {
  ...
  const socialLinks = useMemo(() => {
    return [
      { label: "Instagram", field: bloggerProfile.socialInstagram },
      { label: "Facebook", field: bloggerProfile.socialFacebook },
      { label: "LinkedIn", field: bloggerProfile.socialLinkedin },
      { label: "TikTok", field: bloggerProfile.socialTiktok },
      { label: "YouTube", field: bloggerProfile.socialYoutube },
      { label: "Pinterest", field: bloggerProfile.socialPinterest },
      { label: "Reddit", field: bloggerProfile.socialReddit },
      { label: "Website", field: bloggerProfile.socialWebsite },
      { label: "Linktree", field: bloggerProfile.socialLinktree },
      { label: "Newsletter", field: bloggerProfile.socialNewsletter },
      { label: "WhatsApp-Kanal", field: bloggerProfile.socialWhatsapp },
      { label: "Mailadresse", field: bloggerProfile.socialEmail },
  ...
  return (
    <main className="top-centered-main">
      <section className="card">
        {isLoading ? (
          <p className="font-sans text-arena-muted text-sm mt-4">Lade Bloggerprofil ...</p>
        ) : message ? (
          ...
          <>
              ...
              <div className="my-2">
                ...
                <div className="flex flex-wrap gap-1.5 font-sans">
                  {genres.map((g) => (
                    <span
                      key={g}
                      className="font-sans inline-block rounded-full bg-arena-blue text-white text-xs font-semibold px-2.5 py-1"
                    >
                      {g}
                    </span>
                  ))}
            ...
            {visibleLieblingsbuch && (
              <div className="my-2 font-sans">
                <h2 className="font-sans text-lg font-bold text-arena-blue mb-1.5 mt-3">Lieblingsbuch</h2>
                <p className="font-sans flex items-center gap-1.5 text-arena-text text-sm">
            ...
            {visibleBeschreibung && (
              <div className="my-2">
                <h2 className="font-sans text-lg font-bold text-arena-blue mb-1.5 mt-3">Über mich</h2>
                <p className="font-sans text-sm text-arena-text leading-relaxed mt-1.5 whitespace-pre-line"><LinkifyText text={visibleBeschreibung} /></p>
              </div>
            )}
        ...
        />
        <Link href="/blogger" className="btn font-sans mt-6">Zurück zu Blogger entdecken</Link>
      </section>
    </main>
  );
}
