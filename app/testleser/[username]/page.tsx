...
export default function TestleserProfilePage({ params }: PageProps) {
  ...
  const visibleName = useMemo(() =>
    testleserProfile.name.visibility === "public" && testleserProfile.name.value
      ? testleserProfile.name.value
      : username,
  [testleserProfile.name, username]);

  const genres = useMemo(() =>
    testleserProfile.genres ? parseGenres(testleserProfile.genres) : [],
  [testleserProfile.genres]);

  const socialLinks = useMemo(() => {
    return [
      { label: "Instagram", field: testleserProfile.socialInstagram },
      { label: "Facebook", field: testleserProfile.socialFacebook },
      { label: "LinkedIn", field: testleserProfile.socialLinkedin },
      { label: "TikTok", field: testleserProfile.socialTiktok },
      { label: "YouTube", field: testleserProfile.socialYoutube },
      { label: "Pinterest", field: testleserProfile.socialPinterest },
      { label: "Reddit", field: testleserProfile.socialReddit },
      { label: "Website", field: testleserProfile.socialWebsite },
      { label: "Linktree", field: testleserProfile.socialLinktree },
      { label: "Newsletter", field: testleserProfile.socialNewsletter },
      { label: "WhatsApp-Kanal", field: testleserProfile.socialWhatsapp },
      { label: "Mailadresse", field: testleserProfile.socialEmail },
