...
export default function SiteHeader() {
  ...
  const loggedInLinks = (
    <>
      ...
      <Link href="/buchzirkel" className="header-link-member w-full sm:w-auto">Buchzirkel</Link>
      <Link href="/gewinnspiel" className="header-link-member w-full sm:w-auto">Gewinnspiele</Link>
